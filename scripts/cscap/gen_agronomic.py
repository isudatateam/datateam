...
for site in sites:
    ...
    for yr in years:
        ...
        for i, plotid in enumerate(plotids):
            ...
            cell = spr_client.get_cell(spreadkey, worksheet.id, i + 3, 1)
