...
nt = NetworkTable(("IACLIMATE", "MNCLIMATE", "NDCLIMATE", "SDCLIMATE",
                   "NECLIMATE", "KSCLIMATE", "MOCLIMATE", "KYCLIMATE",
                   "ILCLIMATE", "WICLIMATE", "INCLIMATE", "OHCLIMATE",
                   "MICLIMATE"))
PLOTS = ['annual_sum_precip', 'annual_avg_temp', 'frost_free',
         'gdd50', 'hdd65']
PLOTS = ['summer_avg_temp', 'fall_avg_temp', 'spring_avg_temp',
         'winter_avg_temp']
PLOTS = ['summer_avg_high', 'winter_avg_low', 'summer_avg_low',
         'winter_avg_low']
