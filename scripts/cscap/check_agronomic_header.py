...
IGNORE = ['Rep', 'Tillage', 'Rotation', 'Drainage', 'PlotID', 'ROW',
          'COLUMN', 'UniqueID', 'Nitrogen', 'Landscape']


def build_xref():
    f = sheets.spreadsheets().get(spreadsheetId='1PKK-vWuOryYFOSYSgt4TosrjIDX_F-opHOvrEo5q-i4',
