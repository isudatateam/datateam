...
feed = spr_client.get_list_feed('1tQvw-TQFtBI6xcsbZpaCHtYF7oKZEXNXy-CZHBr8Lh8',
                                'od6')

for entry in feed.entry:
    data = entry.to_dict()
    cursor.execute("""select us_l4code, us_l4name, l4_key from echoregions_l4
    ...
    print data['latitude'], data['longitude'], newval
