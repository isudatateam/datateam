...
def main():
    ...
    df = read_sql("""SELECT uniqueid, plotid, depth, varname, year,
        ...
        and varname in ('SOIL2', 'SOIL39', 'SOIL41', 'SOIL29', 'SOIL34',
        'SOIL30', 'SOIL31', 'SOIL35', 'SOIL33', 'SOIL42', 'SOIL32')
        """, pgconn, index_col=None)

    df = pd.pivot_table(df, values='value', index=['uniqueid', 'plotid',
                                                   'depth', 'year',
                                                   'subsample'],
                        columns=['varname'])
