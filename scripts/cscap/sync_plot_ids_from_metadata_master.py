                    ...
                    for nit in trt["NIT"]:
                        for lnd in trt["LND"]:
                            for rep in range(1, trt["REPS"] + 1):
                                thisID = "%s||%s||%s||%s||%s||%s" % (
                                    get_just_code(
                                        treatment_names.get(till, "")
                                    ),
                                    get_just_code(
                                        treatment_names.get(rot, "")
                                    ),
                                    get_just_code(
                                        treatment_names.get(nit, "")
                                    ),
                                    get_just_code(
                                        treatment_names.get(lnd, "")
                                    ),
                                    get_just_code(
                                        treatment_names.get(drain, "")
                                    ),
                                    rep,
                                )
                                ...
                                entry.set_value(
                                    "tillage", treatment_names.get(till, "")
                                )
                                entry.set_value(
                                    "rotation", treatment_names.get(rot, "")
                                )
                                entry.set_value(
                                    "nitrogen", treatment_names.get(nit, "")
                                )
                                entry.set_value(
                                    "landscape", treatment_names.get(lnd, "")
                                )
                                entry.set_value(
                                    "drainage", treatment_names.get(drain, "")
                                )
